...
export class DayTwoVenueThreeTimetableComponent implements OnInit {
    ...
    this.artistService.getArtistsByDayByVenue(2, 3)
      .subscribe(artists => {
        ...
        this.artists.forEach(a => {
          ...
          this.timeTableDayTwoVenueThree.shows.push(a.show);
          this.timeTableDayTwoVenueThree.getIns.push(a.getIn);
          this.timeTableDayTwoVenueThree.setUpWings.push(a.setUpWings);
          this.timeTableDayTwoVenueThree.soundChecks.push(a.soundCheck);
        });
        console.log(' DayTwoVenueThreeTimetableComponent -> ngOnInit -> this.artists', this.artists);
        console.log(' DayTwoVenueThreeTimetableComponent -> ngOnInit -> this.timeTableDayTwoVenueThree', this.timeTableDayTwoVenueThree);
  ...
  addTimeTable(tt, selector, timeTable) {
    ...
    console.log(' DayTwoVenueThreeTimetableComponent -> addTimeTable -> this.scopeTime', this.scopeTime);
    ...
    timeTable.getIns.forEach(g => {
      if (g.start && g.end !== null) {
        ...
        // console.log(' DayTwoVenueThreeTimetableComponent -> addTimeTable -> g.start', g.start);
      }
    });
    ...
    timeTable.setUpWings.forEach(suw => {
      if (suw.start && suw.end !== null) {
        ...
        // console.log(' DayTwoVenueThreeTimetableComponent -> addTimeTable -> suw.start', suw.start);
      }
    });
    ...
    timeTable.soundChecks.forEach(sc => {
      if (sc.start && sc.end !== null) {
        ...
        // console.log(' DayTwoVenueThreeTimetableComponent -> addTimeTable -> sc.start', sc.start);
      }
    });
    ...
    timeTable.shows.forEach(s => {
      if (s.start && s.end !== null) {
        ...
        // console.log(' DayTwoVenueThreeTimetableComponent -> addTimeTable -> s.start', s.start);
      }
    });
